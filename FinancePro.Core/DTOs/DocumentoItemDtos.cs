...
public sealed class DocumentoItemDto
{
 ...
 public override string ToString()=>string.IsNullOrWhiteSpace(ProdutoCodigo)?ProdutoNome:$"{ProdutoCodigo} · {ProdutoNome}";
}
...
public sealed class AtualizarDocumentoItemDto
{
 public int Id {get;set;} public int DocumentoId {get;set;} public int ProdutoId {get;set;} public decimal Quantidade {get;set;} public decimal PrecoUnitario {get;set;} public decimal DescontoPercentual {get;set;} public decimal IvaPercentual {get;set;}
}
